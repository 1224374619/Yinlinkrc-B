...
//城市
export const city = () => Vue.$local.get('/city.json');
// 行业
export const industry = () => Vue.$local.get('/industry.json');
//获取所有职位类型
export const allpositionCatalog = () => Vue.$local.get('/positionCatalog.json');
//获取所有企业类别
export const enterpriseForm = () => axios.get('/constant/enterpriseForm');
...
//获取职位列表
export const positionlist = (id,params) => axios.get(`/consumer-core/company/${id}/position`,{params:params});
//职位分类
export const positionCatalogs = (id) => axios.get(`/consumer-core/company/${id}/positionCatalog`);
...
//公司搜索
export const companySearch = (params) => axios.post('/consumer-core/searched/company',params);
//职位搜索
export const positionSearch = (params) => axios.post('/consumer-core/searched/position',params);
//获取简单选项信息
...
//搜索
export const homeSearch = (params) => axios.post('/consumer-core/searched/position',params);
...
//获取推荐职位
export const searched = (params) => axios.post('/consumer-core/searched/position',params);
